...
const MAPBOX_TOKEN = 'pk.eyJ1IjoiYXJ5YW5raXJzYWxpIiwiYSI6ImNsZGw3MHBoaTA5NHozcW1yb3h4dnNodmIifQ.Oe87GA6MHZDndBZnQuVWVQ'; 
function App() {
        ...
        {pins.map((p) => (
          <>
            <Marker
              latitude={p.lat}
              longitude={p.long}
              //offsets to center the marker on the map wrt the longitude and latitude
